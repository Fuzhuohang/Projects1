        ...
        case '/form':
            if (req.method == 'POST') {
                ...
                req.on('end', function() {
                    ...
                    res.write('td {background-color:light-grey}\n');
                    res.write('caption {font-weight:bold}\n');
                    res.write('article {text-align: center}</style>');
                ...
                res.end('<html><head><title>405 Method not supported</title></head><body>' +
                    '<article><h1>Method not supported</h1></article></body></html>');
            }
            break;
        default:
            res.writeHead(404, "Not found", { 'Content-Type': 'text/html' });
            res.end('<html><head><title>404 Not Found</title></head><body>' +
                '<article><h1>Not Found</h1></article></body></html>');
